...
Because $\xi_k$ is $\mathcal{F}_{k-1}$-measurable (predictable), and $\tilde{S}_k$ is a $\mathbb{Q}$-martingale, by the tower property of conditional expectation, the expected increments evaluate progressively to zero:
$$ \mathbb{E}^{\mathbb{Q}}\left[ \xi_k \cdot (\tilde{S}_k - \tilde{S}_{k-1}) \mid \mathcal{F}_t \right] = \mathbb{E}^{\mathbb{Q}}\left[ \mathbb{E}^{\mathbb{Q}}\left[ \xi_k \cdot (\tilde{S}_k - \tilde{S}_{k-1}) \mid \mathcal{F}_{k-1} \right] \mid \mathcal{F}_t \right] = \mathbb{E}^{\mathbb{Q}}\left[ \xi_k \cdot 0 \mid \mathcal{F}_t \right] = 0. $$
